...
""", [
    ...
    ('d1a5cfe1-9e55-4c2f-92f3-74bd87ed014e', 'Derick', 'Avungashi', 'derick.admin@example.com', 'hashed_pw3', "", 'admin'),
    ('e34b7112-91e4-4adf-b812-0bb4ef762223', 'Abraham', 'Eve', 'eve.host@example.com', 'hashed_pw4', '+254713333333', 'host'),
    ('f92374d1-d0f1-4e6a-9b4f-f9e2f6f6de22', 'Emily', 'Mutiso', 'emily.guest@example.com', 'hashed_pw5', "", 'guest')
])
